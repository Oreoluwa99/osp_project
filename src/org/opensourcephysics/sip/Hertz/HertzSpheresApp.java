	...
	*/
		...
		if (particles.steps == particles.stop){
			...
			if (dryVolFrac < dryVolFracMax){
					...
					if (lambda == 1){
						...
						totalSum = (pairEnergyTotalPerVolume + freeEnergyPerVolume + freeEnergyIdealPerVolume);
	...
	public void writeData(){
		...
		try {
			...
			bw1.newLine();	
			bw1.write("DryVolFrac, SumOfEnergies, pairFreeEnergy, IdealGasFreeEnergy, FloryRehnerFreeEnergy, meanPressure(), calculatedPressure");
			bw1.newLine();		
