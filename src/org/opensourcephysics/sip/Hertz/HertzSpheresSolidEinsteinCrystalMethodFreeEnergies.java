...
public class HertzSpheresSolidEinsteinCrystalMethodFreeEnergies {
   ...
   */
   ...
   public double meanboltzmannFactor(){ // mean boltzmannFactor
      return boltzmannFactorAccumulator/N/numberOfConfigurations;
   }

   public double meanSpringEnergyAccumulator(){ // mean springEnergyAccumulator
