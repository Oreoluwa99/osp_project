/*
 * =============================================================================================
 * ROOT MODEL: HertzSpheresSolidPhase - Formerly HertzSpheresSolidPhaseFloryHertzModel.java
 * =============================================================================================
 * This class implements the baseline Monte Carlo simulation of 
 * compressible microgels interacting via the Hertz elastic pair 
 * potential and swelling according to the Flory-Rehner free energy.
 *
 * PURPOSE:
 * - Serves as the foundational model for studying microgel suspensions 
 *   without additional complexity.
 * - Provides the reference framework before introducing new physics 
 *   such as faceting and interpenetration of microgels.
 * - Establishes the core data structures, initialization routines, and 
 *   energy calculations that are reused and extended in later models.
 *
 * NOTES:
 * - All particles are treated as spherical, deformable microgels.
 * - Interactions are pairwise Hertzian and Flory-Rehner swelling only.
 * - Faceting and interpenetration effects are not included here, but 
 *   branch from this root model in subsequent implementations.
 * =============================================================================================
 */
