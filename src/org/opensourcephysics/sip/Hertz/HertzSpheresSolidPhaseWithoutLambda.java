...
public class HertzSpheresSolidPhaseWithoutLambda {
...
*/
   ...
   public double calculateFreeEnergyDifference(){ 
     // System.out.println("energyDifference = " + (initialEnergy-Math.log(pairPotentialDifferenceAccumulator))/N/(double)(steps));
