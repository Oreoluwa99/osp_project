   ...
   */
   ...
   public void step() { // performs a trial move of every particle
      ...
      for (int i = 0; i < N; i++) { // attempt a trial move (displacement and size change)
         ...
         for (int neighborIdx = 0; neighborIdx < 12; neighborIdx++) {
               int j = nearestNeighbors[i][neighborIdx];// consider interactions with other particles
   ...
   public void calculateTotalEnergy(double lambda) {
      ...
      for (int i = 0; i < N; ++i) {
         ...
         for (int neighborIdx = 0; neighborIdx < 12; neighborIdx++) {
               int j = nearestNeighbors[i][neighborIdx]; // skip self
