 ...
 */
 ...
 public class HertzSpheresSolidChangedVariablesApp extends AbstractSimulation {
    public enum WriteModes{WRITE_NONE, WRITE_RADIAL, WRITE_ALL;};
	HertzSpheresSolidVegasEdited particles = new HertzSpheresSolidVegasEdited(); // with equilibration
//	HertzSpheresSolidEinsteinCrystal particles = new HertzSpheresSolidEinsteinCrystal();	// without equilibration
	...
	public static void main(String[] args) { // set up animation control
			...
			SimulationControl control = SimulationControl.createApp(new HertzSpheresSolidChangedVariablesApp());
	}
}
