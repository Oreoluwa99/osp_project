   ...
   */
   ...
   public void step() { // performs a trial move of every particle
      ...
      for (int i = 0; i < N; i++) { // attempt a trial move (displacement and size change)
         ...
         de = newEnergy-energy1[i]; // change in total energy due to trial move
         ...
         if(Math.exp(-de) < Math.random()) { // Metropolis algorithm
            ...
            energy1[i] = newEnergy; // update energy of moved particle
   ...
   public void calculateTotalEnergy(double lambda) {
      ...
      for(int i = 0; i < N; ++i) {
         ...
         energy1[i] = pairEnergySum1 + totalF + springEnergy; // total energy of particle i for the lambda = 1 system
         energy[i] = pairEnergySum + totalF + springEnergy; // total energy of particle i for the lambda system
