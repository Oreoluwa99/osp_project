/*
 * In this code, I account for the local faceting of the microgels in the step() method, 
 * but started from the initial algorithm set up for the calculation of free energies using the 
 * approach by Vegas et. al. It is all set up for Faceting and works just fine.
 */
 ...
 public class HertzSpheresLocalFacetFreeEnergies {
    ...
    */
    ...
    public void step() { // performs a trial move of every particle
       ...
       for (i = 0; i < N; i++) { // attempt a trial move (displacement and size change)
         ...
         de = lambda*(pairEnergySum-energy[i])+(1-lambda)*(pairPotentialCorrection)+dFlory; // change in total energy
