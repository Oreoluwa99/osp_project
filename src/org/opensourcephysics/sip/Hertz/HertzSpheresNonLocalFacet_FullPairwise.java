/*
 * HertzSpheresNonLocalFacet_FullPairwise.java
 *
 * Monte Carlo simulation of compressible microgels using full pairwise interactions 
 * (no neighbor restriction) and non-local facet model.
 *
 * This version calculates cap volumes and Flory-Rehner free energies using 
 * interactions between every pair of overlapping microgels (i.e., O(N^2) scaling).
 * 
...
public class HertzSpheresNonLocalFacet_FullPairwise {
