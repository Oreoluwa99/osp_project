 ...
 */
 ...
 public class HertzSpheresSolidEditedApp extends AbstractSimulation {
...
//	HertzSpheresSolidPhaseTrialCode particles = new HertzSpheresSolidPhaseTrialCode();
	...
	double helmhotzFreeEnergyPerVolume, helmhotzFreeEnergy, delta3;
	...
	List<Double> delta3List = new ArrayList<>();
		...
		if (particles.steps == particles.stop){
			...
			//	control.println("Initial Energy U_0 = " + particles.initialEnergy);
				...
				if (lambda==0){
					...
					delta3 = Math.log(particles.N)/particles.N;
					...
					helmhotzFreeEnergy = einsteinFreeEnergy-idealContribution1-idealContribution2+1.0+delta3+delta1+delta2;
	...
	public void writeData(){
		...
		try {
			...
			bw1.newLine();	
			bw1.write("DryVolFrac, totalSumOfEnergies, delta1, delta2, delta3, excessHelmhotzFreeEnergy/V, floryRehnerFreeEnergy/V");
			bw1.newLine();	

			for (int i = 0; i < dryVolFracs.size(); i++) {
				double roundedDryVolFrac = Double.parseDouble(decimalFormat.format(dryVolFracs.get(i)));
				bw1.write(roundedDryVolFrac + ", " + totalSumOfEnergiesList.get(i)+ ", " + delta1List.get(i) + ", " + delta2List.get(i) + ", " + delta3List.get(i) + ", " + excessHelmhotzFreeEnergyPerVolumes.get(i)+", " + meanFreeEnergyPerVolumes.get(i));
				bw1.newLine();
			}
	...
	public static void main(String[] args) { // set up animation control
			...
			SimulationControl control = SimulationControl.createApp(new HertzSpheresSolidEditedApp());
	}
}
