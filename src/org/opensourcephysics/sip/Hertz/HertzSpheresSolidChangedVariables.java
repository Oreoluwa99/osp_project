...
public class HertzSpheresSolidChangedVariables {
    ...
    public double limitIncrement, upperLimit;
   ...
   */
   ...
   public void step() { // performs a trial move of every particle
      ...
      for (int i = 0; i < N; i++) { // attempt a trial move (displacement and size change)
         ...
         newEnergy += (1-lambda)*springEnergy+totalF; // total energy after trial move
