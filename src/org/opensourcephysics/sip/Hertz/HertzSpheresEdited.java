...
public class HertzSpheresEdited {
    ...
    public double dryVolFrac=0.01, volFrac, reservoirVolFrac, dryVolFracStart, dryVolFracMax; 
    ...
    public double lambda, dlambda;
    public double dphi;
    public double mixFRSR, elasticFRSR, totalFRSR;
    public double totalFullPairEnergy;
   ...
   public void step() { // performs a trial move of every particle
      ...
      for (int i = 0; i < N; i++) { // attempt a trial move (displacement and size change)
         ...
         z[i] = PBC.position(z[i]+dztrial, side);
	      ...
	      if (a[i] < 1){
	         System.out.println("Error: radius can never be negative.");
	      }
         ...
         // Flory-Rehner single-particle free energy (associated with swelling)
	      ...
	      System.out.println("nChains = " + nChains);
	      System.out.println("freeEnergyAccumulator = " + freeEnergyAccumulator);
	      System.out.println("totalFreeEnergy = " + totalFreeEnergy);
	      ...
	      System.out.println("mixF= " + mixF + ", elasticF= " + elasticF);
	      totalF = elasticF + mixF;

	      System.out.println("elasticF " + elasticF);
	      System.out.println("mixF " + mixF);
         mixFRSR = nMon*((reservoirSR*reservoirSR*reservoirSR-1)*Math.log(1-1/reservoirSR/reservoirSR/reservoirSR)+chi*(1-1/reservoirSR/reservoirSR/reservoirSR));
	      ...
	      //Flory-Rehner free energy for the fully swollen microgel
	
	      System.out.println("The elasticFRSR " + elasticFRSR);
	      System.out.println("The mixFRSR " + mixFRSR);
      ...
      for(int i = 0; i < N; ++i) {
         ...
         */
         ...
         totalFreeEnergy += totalF;
	      ...
	      // totalFullPairEnergy += pairEnergySum;
