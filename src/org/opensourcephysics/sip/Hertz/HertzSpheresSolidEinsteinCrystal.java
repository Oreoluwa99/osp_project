...
public class HertzSpheresSolidEinsteinCrystal {
   ...
   public void setFCCpositions() {
      ...
      calculateTotalEnergy(lambda); // initial energy 
      initialEnergy = pairEnergyAccumulator;// when lambda = 1
   }
   ...
   */
   ...
   public void calculateTotalEnergy(double lambda) {
      ...
      totalEnergy = totalPairEnergy + totalFreeEnergy; // when lambda = 1
      ...
      // System.out.println("totalPairEnergy = "+totalPairEnergy);
