// package org.opensourcephysics.sip.oreoluwa;
...
public class HertzSpheresAppOriginal extends AbstractSimulation {
	...
	*/
	public void initialize() {
		...
		added = false;
		// particles.lambda = control.getDouble("Coupling constant");
	...
	public void reset() {
		...
		//control.setValue("Coupling constant", 0);
	...
	public static void main(String[] args) { // set up animation control
			...
			SimulationControl control = SimulationControl.createApp(new HertzSpheresAppOriginal());
	}
}
