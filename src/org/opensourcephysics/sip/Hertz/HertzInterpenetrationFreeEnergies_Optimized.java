 ...
 * OPTIMIZED VERSION
 * -------------------------------------------------------------------------
 * This class is an optimized implementation of the Hertz interpenetration
 * Monte Carlo simulation. It is based on the original version
 * (last confirmed working on December 30, 2024, tagged as "_original"
 * on August 16, 2025).
 *
 * Key Notes:
 * - Keeps full physics of interpenetration and free energy calculations.
 * - Adds optimization improvements (structure, efficiency, clarity).
 * - Preserves compatibility with the original reference version.
 *
 *  * @authors Alan Denton and Matt Urich
 * *  @Edited by Oreoluwa Alade *
 *
 * IMPORTANT DATES:
 * - December 30, 2024: Original version confirmed working.
 * - August 16, 2025: Optimized version created from the "_original" baseline.
 *
 *
 * -------------------------------------------------------------------------
 */

public class HertzInterpenetrationFreeEnergies_Optimized {
