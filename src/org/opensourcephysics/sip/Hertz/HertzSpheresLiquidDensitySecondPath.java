...
public class HertzSpheresLiquidDensitySecondPath {
   ...
   */
   ...
   public void calculateTotalEnergy(double lambda) {
      ...
      for(int i = 0; i < N; ++i) {
         ...
         totalFreeEnergy += totalF; // total flory-rehner free energy
   ...
   //   System.out.println("meanFreeEnergy = "+(freeEnergyAccumulator/N/(double)(steps)));
